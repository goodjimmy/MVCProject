...
namespace MVCProject.Controllers
{
    public class GuestbooksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Subject,Content,PostDateTime")] Guestbook guestbook)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Subject,Content,PostDateTime")] Guestbook guestbook)
        {
            if (ModelState.IsValid)
            {
